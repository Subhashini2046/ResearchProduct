...
def executeForAFile(filename, output_file_name, cwd):
    ...
    print("enhanced_feature_sum111",enhanced_feature_sum)

    # length_to_be_extracted = len(enhanced_feature_sum) // 2
    length_to_be_extracted = (len(enhanced_feature_sum)*50) // 100
    print("len(enhanced_feature_sum) :",len(enhanced_feature_sum),length_to_be_extracted )
    print("\n\nThe text is : \n")
    ...
    print("extracted_sentences  :",extracted_sentences)
    indeces_extracted = []
